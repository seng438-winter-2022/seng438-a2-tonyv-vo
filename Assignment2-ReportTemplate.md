...
- [2 Detailed descriptions of unit test strategy](#2-detailed-descriptions-of-unit-test-strategy)
  ...
  - [Test cases 22-23 for createNumberArray(double[] data)](#test-cases-1--7-for-getupperbound)
  - [Test cases 24-25 for createNumberArray2D(double [][] data)](#test-cases-1--7-for-getupperbound)
  - [Test cases 26-28 for constrain(double data)](#test-cases-1--7-for-getupperbound)
